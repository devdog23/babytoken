...
async function main(){
    ...
    const myKeypair = loadWalletKey("WNeRSvbt2xVkHgLqmcwKzy1mfHYij9HE5PzxHoKDkoR.json"); // Signer Wallet Address
    const mint = new web3.PublicKey("5myEzfDaGv6TW83gQAYSyRqJ2Ztep2gdawwhV21sQ3jd"); // Token Address
    ...
    const ourMetadata = { // TODO change those values!
        name: "Baby Token", 
        symbol: "BT",
        uri: "https://raw.githubusercontent.com/devdog23/babytoken/main/metadata.json",
    }
    const onChainData = {
        ...ourMetadata,
        // we don't need that
